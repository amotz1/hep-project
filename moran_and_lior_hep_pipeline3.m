function moran_and_lior_hep_pipeline3()
%% loading the data
...
%% making new comp.trial 
[eegFieldtrip] = eeglab2fieldtrip_lior(fRefCopyEEG, 'preprocessing');
eegFieldtrip.trial{1} = ft_preproc_baselinecorrect(eegFieldtrip.trial{1});
comp.trial = {comp.unmixing * eegFieldtrip.trial{1}(1:64,:)};
%% browse ica
cfg = [];
...
browseEegLabData(dataAfterEpoching);
%%
cutoff = 0.5;
...
%% transfering the clean data to eeg data structure for visual inspection
